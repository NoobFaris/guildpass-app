...
import type { Pass, Guild, Member } from "../../mock-data.ts";
...
import { mockPasses, mockGuilds, mockMembers } from "../../mock-data.ts";
import { DEFAULT_SETTINGS } from "../../settings.ts";
import { filterMembers, filterPasses, paginateItems } from "../../../lib/pagination.ts";

// Local helper implementation to completely bypass Node import resolution bugs
const computeDiff = (oldData: any, newData: any): any[] => {
  const changes: any[] = [];
